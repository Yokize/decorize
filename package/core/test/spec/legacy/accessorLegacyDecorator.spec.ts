...
describe('accessorLegacyDecorator', (): void => {
  ...
  test('should create and register decorator', async (): Promise<void> => {
    ...
    const decorator: MethodDecorator = accessorLegacyDecorator(entry.name, null, (): any => descriptor);
  ...
  test('should create and register decorator with metadata', async (): Promise<void> => {
    ...
    // Var: newly created accessor decorator.
    const decorator: MethodDecorator = accessorLegacyDecorator('decorator', metadata);
